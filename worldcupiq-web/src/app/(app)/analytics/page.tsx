    ...
    return (
      <div className="mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        <p className="mb-8 text-muted-foreground">
          Unlock detailed insights — accuracy by category, difficulty breakdown,
          session trends, and more — with a Premium subscription.
        </p>
        <Button
          asChild
    ...
    <div className="mx-auto max-w-4xl px-4 py-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-muted-foreground">
          Your detailed WorldCupIQ stats.
        </p>
      </div>
            ...
            <Card className="border-border bg-card">
              <CardContent className="flex items-center gap-4 p-5">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {data?.avgAnswerMs
                      ? `${msToSeconds(data.avgAnswerMs)}s`
                      : "—"}
                  </p>
                </div>
              </CardContent>
          ...
          <CardContent className="space-y-4">
            {isLoading ? (
              ...
              <p className="text-sm text-muted-foreground">
                Play more games to see category stats.
              </p>
            )}
          </CardContent>
        </Card>
        ...
        <Card className="border-border bg-card">
          ...
          <CardContent className="space-y-4">
            {isLoading ? (
              ...
              <p className="text-sm text-muted-foreground">
                Play more games to see difficulty stats.
              </p>
            )}
          </CardContent>
        </Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="flex items-end gap-1 h-28">
                {(() => {
                  const trend = data.dailyTrend as {
                    date: string;
                    score: number;
                    sessions: number;
                  }[];
                  ...
                  return trend.map((t) => (
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          height: `${Math.max((t.score / maxScore) * 100, 4)}%`,
                        }}
                      />
              ...
              <p className="text-sm text-muted-foreground">
                Play daily challenges to build your trend data.
              </p>
            )}
          </CardContent>
        </Card>
