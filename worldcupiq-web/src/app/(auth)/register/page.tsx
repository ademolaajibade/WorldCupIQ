...
export default function RegisterPage() {
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      toast.success('Account created! Welcome to WorldCupIQ');
  ...
  return (
    <Card className="border-border bg-card">
      <CardHeader className="text-center">
        ...
        <CardDescription>Join millions testing their World Cup knowledge</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input id="country" placeholder="e.g. NG, US, BR" maxLength={2} className="uppercase" {...register('country')} />
          </div>
